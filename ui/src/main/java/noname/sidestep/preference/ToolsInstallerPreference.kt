 ...
 */
package noname.sidestep.preference
...
import noname.sidestep.util.lifecycleScope
        ...
        lifecycleScope.launch {
            try {
                ...
                when {
                    ...
                    state and (ToolsInstaller.MAGISK or ToolsInstaller.NO) == ToolsInstaller.MAGISK or ToolsInstaller.NO -> setState(
                        State.INITIAL_MAGISK
                    )
                    state and (ToolsInstaller.SYSTEM or ToolsInstaller.NO) == ToolsInstaller.SYSTEM or ToolsInstaller.NO -> setState(
                        State.INITIAL_SYSTEM
                    )
